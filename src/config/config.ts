...
const env = envalid.cleanEnv(process.env, {
    ...
    SYSTEM_ASAP_JWT_COMPONENT_KEY_CLAIM: envalid.str({ default: 'sub',
        desc: 'The claim of the system token which carries the componentKey the token is authorized for' }),
    WS_REQUIRE_COMPONENT_KEY_CLAIM: envalid.bool({ default: false,
        desc: 'Reject websocket connections whose system token does not carry the componentKey claim' }),
...
export default {
    ...
    SystemAsapJwtComponentKeyClaim: env.SYSTEM_ASAP_JWT_COMPONENT_KEY_CLAIM,
    WsRequireComponentKeyClaim: env.WS_REQUIRE_COMPONENT_KEY_CLAIM,
