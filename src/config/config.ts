...
const env = envalid.cleanEnv(process.env, {
    ...
    SYSTEM_ASAP_BASE_URL_MAPPINGS: envalid.json({ default: '[{"kid": "^jitsi/(.*)$", "baseUrl": "https://localhost:18443/server"}]' }),
    ...
    JITSI_ASAP_BASE_URL_MAPPINGS: envalid.json({ default: '[{"kid": "^jitsi/(.*)$", "baseUrl": "https://localhost:18433/clients"} ]' }),
